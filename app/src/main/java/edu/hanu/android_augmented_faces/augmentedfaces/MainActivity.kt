package edu.hanu.android_augmented_faces.augmentedfaces
...
import edu.hanu.android_augmented_faces.R
import edu.hanu.android_augmented_faces.comon.helpers.*
import edu.hanu.android_augmented_faces.comon.rendering.BackgroundRenderer
import edu.hanu.android_augmented_faces.comon.rendering.ObjectRenderer
        ...
        if (session == null) {
            ...
            try {
                ...
                if (!CameraPermissionHelper.hasCameraPermission(this)) {
                    CameraPermissionHelper.requestCameraPermissions(this)
                    return
                }
